...
Replace the hostname, bucket, JWT issuer, JWT audience, scope, and credential
values before applying them. For production, prefer a secret manager or
workload-identity ServiceAccount rather than committing credential values.
