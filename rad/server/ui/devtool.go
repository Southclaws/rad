...
import (
	...
	"github.com/Southclaws/rad/rad/engine/05_exec"
)
...
func (s *devtool) handleMeta(w http.ResponseWriter, r *http.Request) {
...
func (s *devtool) handleSchema(w http.ResponseWriter, r *http.Request) {
...
func (s *devtool) handleTableRows(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (s *devtool) handleIndexScan(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
