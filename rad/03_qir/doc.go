...
// relations and produce relations. An Expr is a scalar computation evaluated
// in some scope; expressions may consume relations, but only through an
// explicit cardinality-crossing operator (Exists, First, Scalar, Array) that
// states how many-becomes-one. Result shaping is projection: a Project field
