...
//	            SlateDB adapter, in-memory test double
//	            <- may not import anything above
//	02_catalog  schema: tables, columns, indexes, constraints
//	            <- imports 01
//	03_lir      logical IR (RADLIR): the semantic query model every
//	            frontend targets; storage-free, index-free, strategy-free
//	            <- imports 02 only for the shared type vocabulary
//	04_planner  logical IR -> physical plan: resolves tables/indexes,
//	            access paths, join strategy
//	            <- imports 02 + 03
