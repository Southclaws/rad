...
func (db *DB) WaitMigration(ctx context.Context, result migration.MigrationResult) (migration.MigrationResult, error) {
	return db.migrationService().WaitMigration(ctx, result)
}
