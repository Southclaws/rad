...
func (ex *Executor) buildPKGet(ctx context.Context, n *planner.PKGetExec, outer lireval.Env) (operator, error) {
	...
	row, _, _, err := rowstore.GetColumns(ctx, ex.view, n.Scan.Table, key, n.DecodeColumns)
	if err != nil {
		return nil, err
	}
...
func (ex *Executor) buildIndexScan(ctx context.Context, n *planner.IndexRangeScanExec, outer lireval.Env) (operator, error) {
	...
	it, err := rowstore.ScanIndexRangeColumns(
		ctx, ex.view, n.Scan.Table, n.Index, equal, bounds, n.DecodeColumns,
	)
	if err != nil {
		return nil, err
	}
