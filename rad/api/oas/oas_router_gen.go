		...
		case '/': // Prefix: "/"
			...
			case 's': // Prefix: "schema"
				...
				case '/': // Prefix: "/"
					...
					case 't': // Prefix: "transitions"

						if l := len("transitions"); len(elem) >= l && elem[0:l] == "transitions" {
							elem = elem[l:]
						} else {
							break
						}
						...
						if len(elem) == 0 {
							switch r.Method {
							case "GET":
								s.handleSchemaTransitionListRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
									allowedMethods: "GET",
									allowedHeaders: nil,
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								switch r.Method {
								case "GET":
									s.handleSchemaTransitionGetRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
							...
							case '/': // Prefix: "/cancel"
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "POST":
										s.handleSchemaTransitionCancelRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
				...
				case '/': // Prefix: "/"
					...
					case 'm': // Prefix: "migrate"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.summary = "Start or recover reconciliation with a desired schema."
					...
					case 't': // Prefix: "transitions"
						...
						if len(elem) == 0 {
							switch method {
							case "GET":
								r.name = SchemaTransitionListOperation
								r.summary = "List durable online schema transitions."
								r.operationID = "SchemaTransitionList"
								r.operationGroup = ""
								r.pathPattern = "/schema/transitions"
								r.args = args
								r.count = 0
								return r, true
							default:
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								switch method {
								case "GET":
									r.name = SchemaTransitionGetOperation
									r.summary = "Inspect one durable online schema transition."
									r.operationID = "SchemaTransitionGet"
									r.operationGroup = ""
									r.pathPattern = "/schema/transitions/{transition}"
									r.args = args
									r.count = 1
									return r, true
								default:
							...
							case '/': // Prefix: "/cancel"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "POST":
										r.name = SchemaTransitionCancelOperation
										r.summary = "Cancel one durable online schema transition."
										r.operationID = "SchemaTransitionCancel"
										r.operationGroup = ""
										r.pathPattern = "/schema/transitions/{transition}/cancel"
										r.args = args
										r.count = 1
										return r, true
									default:
