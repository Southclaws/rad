...
// Package tracker defines a type-safe Rad database client.
package tracker
...
type UserTable struct{ v rad.View }
...
type SessionTable struct{ v rad.View }
...
type TeamTable struct{ v rad.View }
...
type TeamMemberTable struct{ v rad.View }
...
type BoardTable struct{ v rad.View }
...
type TaskTable struct{ v rad.View }
...
type CommentTable struct{ v rad.View }
...
type LabelTable struct{ v rad.View }
...
type TaskLabelTable struct{ v rad.View }
