...
//
// POST /query
func (UnimplementedHandler) Query(ctx context.Context, req OptQuery) (r QueryRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// POST /tx/{id}/query
func (UnimplementedHandler) TransactionQuery(ctx context.Context, req OptQuery, params TransactionQueryParams) (r TransactionQueryRes, _ error) {
	return r, ht.ErrNotImplemented
}
