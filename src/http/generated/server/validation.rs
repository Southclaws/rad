...
const VALIDATION_SCHEMA: &str = "{\"$defs\":{\"components\":{\"component_ColumnDef\":{\"description\":\"A column definition for a direct catalog create operation.\",\"properties\":{\"default\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_ColumnDefault\"},\"format\":{\"description\":\"An optional semantic hint such as `uuid`, `ulid`, `xid`, or `unix_ms`.\",\"type\":\"string\"},\"id\":{\"description\":\"An optional stable logical identity; direct mode allocates one when omitted.\",\"format\":\"int64\",\"maximum\":2147483647,\"minimum\":1,\"type\":\"integer\"},\"name\":{\"type\":\"string\"},\"nullable\":{\"type\":\"boolean\"},\"type\":{\"description\":\"The column's storage type, one of `text`, `int64`, `float64`, `bool`, or `bytes`.\",\"type\":\"string\"}},\"required\":[\"name\",\"type\"],\"type\":\"object\"},\"component_ColumnDefault\":{\"description\":\"A column default, applied when an insert omits the column: either a\\nbuiltin generator named by `func` (`uuid_v4` or `uuid_v7` on\\n`bytes format: uuid`, `ulid` on `bytes format: ulid`, `xid` on\\n`bytes format: xid`, and `now_ms` or `increment` on int64 columns)\\nor a literal `value` of the column's type. Exactly one is set.\\n\",\"properties\":{\"func\":{\"description\":\"A builtin generator.\",\"enum\":[\"uuid_v4\",\"uuid_v7\",\"ulid\",\"xid\",\"now_ms\",\"increment\"],\"type\":\"string\"},\"value\":{\"allOf\":[{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_Value\"}],\"description\":\"A literal of the column's type. Formatted byte columns use their canonical identifier text; unformatted bytes use padded base64.\"}},\"type\":\"object\"},\"component_ColumnUpdateProps\":{\"description\":\"The column properties to update.\",\"properties\":{\"name\":{\"description\":\"The column's new name.\",\"type\":\"string\"}},\"required\":[\"name\"],\"type\":\"object\"},\"component_ForeignKeyAction\":{\"description\":\"The action applied to referencing rows when the referenced row is deleted.\",\"enum\":[\"restrict\",\"no_action\",\"cascade\",\"set_null\"],\"type\":\"string\"},\"component_ForeignKeyInfo\":{\"description\":\"One foreign key, in both definitions and introspection. The\\nreferenced columns must be the referenced table's full primary key.\\n\",\"properties\":{\"columns\":{\"description\":\"The referencing column names on this table.\",\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"name\":{\"type\":\"string\"},\"on_delete\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_ForeignKeyAction\"},\"ref_columns\":{\"description\":\"The referenced table's primary key columns, in order.\",\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"ref_table\":{\"description\":\"The referenced table's name.\",\"type\":\"string\"}},\"required\":[\"name\",\"columns\",\"ref_table\",\"ref_columns\",\"on_delete\"],\"type\":\"object\"},\"component_IndexInfo\":{\"description\":\"One secondary index, in both definitions and introspection.\",\"properties\":{\"columns\":{\"description\":\"The indexed column names, in order.\",\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"name\":{\"type\":\"string\"},\"unique\":{\"type\":\"boolean\"}},\"required\":[\"name\",\"columns\"],\"type\":\"object\"},\"component_SchemaCompatibilityRequest\":{\"additionalProperties\":false,\"properties\":{\"schema_hash\":{\"type\":\"string\"},\"schema_version\":{\"format\":\"int64\",\"minimum\":0,\"type\":\"integer\"}},\"required\":[\"schema_version\",\"schema_hash\"],\"type\":\"object\"},\"component_SchemaMigrateRequest\":{\"additionalProperties\":false,\"description\":\"A desired schema, the preflighted server identity, and explicit data-loss consent.\",\"properties\":{\"accept_data_loss\":{\"type\":\"boolean\"},\"current_hash\":{\"type\":\"string\"},\"current_version\":{\"format\":\"int64\",\"minimum\":0,\"type\":\"integer\"},\"schema\":{\"type\":\"string\"}},\"required\":[\"schema\",\"current_version\",\"current_hash\"],\"type\":\"object\"},\"component_SchemaRequest\":{\"additionalProperties\":false,\"description\":\"A desired schema source to plan.\",\"properties\":{\"schema\":{\"description\":\"The full `rad.schema.yaml` source document, as YAML.\",\"type\":\"string\"}},\"required\":[\"schema\"],\"type\":\"object\"},\"component_TableDef\":{\"description\":\"A new table's definition, mirroring a `rad.schema.yaml` entry as JSON. The\\ndirect API may omit logical IDs for the catalog to allocate. Column\\ntypes are `text`, `int64`, `float64`, `bool`, or `bytes`; the primary key is\\nrequired and its columns must not be nullable.\\n\",\"properties\":{\"columns\":{\"items\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_ColumnDef\"},\"type\":\"array\"},\"foreign_keys\":{\"items\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_ForeignKeyInfo\"},\"type\":\"array\"},\"id\":{\"description\":\"An optional stable logical identity; direct mode allocates one when omitted.\",\"format\":\"int64\",\"maximum\":2147483647,\"minimum\":1,\"type\":\"integer\"},\"indexes\":{\"items\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_IndexInfo\"},\"type\":\"array\"},\"name\":{\"type\":\"string\"},\"primary_key\":{\"items\":{\"type\":\"string\"},\"type\":\"array\"}},\"required\":[\"name\",\"columns\",\"primary_key\"],\"type\":\"object\"},\"component_TableUpdateProps\":{\"description\":\"The table properties to update.\",\"properties\":{\"name\":{\"description\":\"The table's new name.\",\"type\":\"string\"}},\"required\":[\"name\"],\"type\":\"object\"},\"component_TransitionKind\":{\"description\":\"The physical protocol used to perform online schema work.\",\"enum\":[\"index_build\",\"column_replacement\",\"constraint_validation\"],\"type\":\"string\"},\"component_TransitionState\":{\"description\":\"The durable lifecycle state of online schema work.\",\"enum\":[\"waiting\",\"building\",\"catching_up\",\"validating\",\"ready\",\"failed\",\"cancelled\"],\"type\":\"string\"},\"component_Value\":{\"description\":\"An arbitrary JSON value carried by the HTTP protocol.\"}},\"targets\":{\"v0\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_SchemaRequest\"},\"v1\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_SchemaMigrateRequest\"},\"v10\":{\"type\":\"string\"},\"v11\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_ColumnDef\"},\"v12\":{\"type\":\"string\"},\"v13\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_ColumnUpdateProps\"},\"v14\":{\"type\":\"string\"},\"v15\":{\"type\":\"string\"},\"v16\":{\"type\":\"string\"},\"v17\":{\"type\":\"string\"},\"v18\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_IndexInfo\"},\"v19\":{\"type\":\"string\"},\"v2\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_SchemaCompatibilityRequest\"},\"v20\":{\"type\":\"string\"},\"v21\":{\"type\":\"string\"},\"v22\":{\"type\":\"string\"},\"v3\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_TransitionKind\"},\"v4\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_TransitionState\"},\"v5\":{\"minLength\":1,\"type\":\"string\"},\"v6\":{\"minLength\":1,\"type\":\"string\"},\"v7\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_TableDef\"},\"v8\":{\"$ref\":\"urn:openapi-to-rust:request-validation#/$defs/components/component_TableUpdateProps\"},\"v9\":{\"type\":\"string\"}}},\"$id\":\"urn:openapi-to-rust:request-validation\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\"}";
const MAX_VALIDATION_ERRORS: usize = 16usize;
pub(crate) const VALIDATION_TARGET_0_BODY: &str = "#/$defs/targets/v0";
pub(crate) const VALIDATION_TARGET_1_BODY: &str = "#/$defs/targets/v1";
pub(crate) const VALIDATION_TARGET_2_BODY: &str = "#/$defs/targets/v2";
pub(crate) const VALIDATION_TARGET_3_QUERY_0: &str = "#/$defs/targets/v3";
pub(crate) const VALIDATION_TARGET_4_QUERY_1: &str = "#/$defs/targets/v4";
...
pub(crate) const VALIDATION_TARGET_7_BODY: &str = "#/$defs/targets/v7";
pub(crate) const VALIDATION_TARGET_8_BODY: &str = "#/$defs/targets/v8";
pub(crate) const VALIDATION_TARGET_9_PATH_0: &str = "#/$defs/targets/v9";
pub(crate) const VALIDATION_TARGET_10_PATH_0: &str = "#/$defs/targets/v10";
pub(crate) const VALIDATION_TARGET_11_BODY: &str = "#/$defs/targets/v11";
pub(crate) const VALIDATION_TARGET_12_PATH_0: &str = "#/$defs/targets/v12";
pub(crate) const VALIDATION_TARGET_13_BODY: &str = "#/$defs/targets/v13";
...
pub(crate) const VALIDATION_TARGET_16_PATH_0: &str = "#/$defs/targets/v16";
pub(crate) const VALIDATION_TARGET_17_PATH_1: &str = "#/$defs/targets/v17";
pub(crate) const VALIDATION_TARGET_18_BODY: &str = "#/$defs/targets/v18";
pub(crate) const VALIDATION_TARGET_19_PATH_0: &str = "#/$defs/targets/v19";
pub(crate) const VALIDATION_TARGET_20_PATH_0: &str = "#/$defs/targets/v20";
pub(crate) const VALIDATION_TARGET_21_PATH_1: &str = "#/$defs/targets/v21";
pub(crate) const VALIDATION_TARGET_22_HEADER_0: &str = "#/$defs/targets/v22";
...
> {
    ...
    let bytes = read_body(body, max_body_bytes).await?;
    if bytes.is_empty() && !required { Ok(None) } else { Ok(Some(bytes)) }
}
