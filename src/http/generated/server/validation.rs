...
pub(crate) const VALIDATION_TARGET_22_BODY: &str = "#/$defs/targets/v22";
pub(crate) const VALIDATION_TARGET_23_HEADER_0: &str = "#/$defs/targets/v23";
