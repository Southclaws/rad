...
type Invoker interface {
	...
	//
	// GET /schema
	GetSchema(ctx context.Context) (GetSchemaRes, error)
	...
	SchemaTransitionList(ctx context.Context, params SchemaTransitionListParams) (SchemaTransitionListRes, error)
	...
	//
	// GET /tables
	TableList(ctx context.Context) (TableListRes, error)
...
func (c *Client) sendColumnUpdate(ctx context.Context, request OptColumnUpdateProps, params ColumnUpdateParams) (res ColumnUpdateRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, ColumnUpdateOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendGetHealthz(ctx context.Context) (res GetHealthzRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, GetHealthzOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendGetInfo(ctx context.Context) (res GetInfoRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, GetInfoOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// GET /schema
func (c *Client) GetSchema(ctx context.Context) (GetSchemaRes, error) {
	res, err := c.sendGetSchema(ctx)
	return res, err
}

func (c *Client) sendGetSchema(ctx context.Context) (res GetSchemaRes, err error) {
...
func (c *Client) sendIndexCreate(ctx context.Context, request OptIndexInfo, params IndexCreateParams) (res IndexCreateRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, IndexCreateOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendIndexDelete(ctx context.Context, params IndexDeleteParams) (res IndexDeleteRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, IndexDeleteOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendQuery(ctx context.Context, request Query, params QueryParams) (res QueryRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, QueryOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendSchemaCompatibility(ctx context.Context, request OptSchemaCompatibilityRequest) (res SchemaCompatibilityRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, SchemaCompatibilityOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendSchemaDiff(ctx context.Context, request OptSchemaRequest) (res SchemaDiffRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, SchemaDiffOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendSchemaMigrate(ctx context.Context, request OptSchemaMigrateRequest) (res SchemaMigrateRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, SchemaMigrateOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendSchemaTransitionCancel(ctx context.Context, params SchemaTransitionCancelParams) (res SchemaTransitionCancelRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, SchemaTransitionCancelOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendSchemaTransitionGet(ctx context.Context, params SchemaTransitionGetParams) (res SchemaTransitionGetRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, SchemaTransitionGetOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// GET /schema/transitions
func (c *Client) SchemaTransitionList(ctx context.Context, params SchemaTransitionListParams) (SchemaTransitionListRes, error) {
	res, err := c.sendSchemaTransitionList(ctx, params)
	return res, err
}

func (c *Client) sendSchemaTransitionList(ctx context.Context, params SchemaTransitionListParams) (res SchemaTransitionListRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, SchemaTransitionListOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendTableCreate(ctx context.Context, request OptTableDef) (res TableCreateRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, TableCreateOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendTableDelete(ctx context.Context, params TableDeleteParams) (res TableDeleteRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, TableDeleteOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
//
// GET /tables
func (c *Client) TableList(ctx context.Context) (TableListRes, error) {
	res, err := c.sendTableList(ctx)
	return res, err
}

func (c *Client) sendTableList(ctx context.Context) (res TableListRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, TableListOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendTableUpdate(ctx context.Context, request OptTableUpdateProps, params TableUpdateParams) (res TableUpdateRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityBearerAuth(ctx, TableUpdateOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
