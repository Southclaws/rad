...
// rejects lossy or locale-dependent conversions. Replacement of columns
// used by primary keys, indexes, or foreign keys is rejected, because
// their physical access paths cannot participate in the same transition.
//
...
//
// The only constraint kind is a single-column `not_null`. A successful
