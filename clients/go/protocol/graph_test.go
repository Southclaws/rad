...
func TestStrictQueryWireValidation(t *testing.T) {
	cases := []struct {
		...
		{"unknown text comparison", `{"nodes":{"s":{"kind":"scan","table":"tasks","scope":"s"},"f":{"kind":"filter","input":"s","predicate":{"kind":"text_match","value":{"kind":"col","scope":"s","column":"name"},"comparison":"locale_magic","parts":[{"kind":"literal","value":"x"}]}}},"root":{"node":"f","cardinality":"many"}}`},
