...
| `23` | `catalog_column_increment` | `table:physical_id(t) column:be32` | last committed non-negative int64 decimal text |
| `24` | `catalog_table_data_generation_stripe` | `table:physical_id(t) stripe:uvarint` | data generation decimal text |
| `25` | `catalog_schema_table_id_high_water` | `(the tag is the whole key)` | largest allocated table schema identity decimal text |
| `26` | `catalog_schema_column_id_high_water` | `table:be32` | largest allocated column schema identity decimal text |
...
| `50` | `statistics_table_changes` | `schema:be32` | modification count decimal text |
| `51` | `statistics_model` | `family:bytes` | json feedback model document |
| `55` | `statistics_relation_model` | `family:bytes` | json relation feedback model document |
| `56` | `statistics_model_catalog` | `(the tag is the whole key)` | json statistics model catalog document |
| `57` | `statistics_frequency` | `family:bytes` | [`statistics/frequency.v1`](#statisticsfrequencyv1) |
| `58` | `statistics_frequency_epoch` | `(the tag is the whole key)` | decay epoch decimal text |
| `52` | `corpus_program` | `canonical_version:uvarint content_hash:bytes` | canonical PIR document bytes. Invariant: immutable once written: a different document under an existing key is corruption |
| `53` | `corpus_execution` | `at:be64 sequence:uvarint` | json execution observation document |
| `54` | `statistics_synopsis` | `schema:be32` | json synopsis model document |
...
| `schema.tables[].columns[].default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `schema.tables[].columns[].default.float64` | `number` |  | Literal used when the column type is float64. |
| `schema.tables[].columns[].default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `schema.tables[].columns[].type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of the column. |
...
| `schema.tables[].foreign_keys[].on_delete` | `restrict \| cascade \| set_null` |  | Action applied to referencing rows when the parent row is deleted. Absent means restrict. |
...
| `columns[].insert_default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `columns[].insert_default.float64` | `number` |  | Literal used when the column type is float64. |
| `columns[].insert_default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function. Present when the default is generated per row instead of a literal. |
...
| `columns[].missing_value.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `columns[].missing_value.float64` | `number` |  | Literal used when the column type is float64. |
| `columns[].missing_value.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present in the shape because the default-value form is shared. |
...
| `columns[].type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of every stored cell in this column. |
...
| `foreign_keys[].on_delete` | `restrict \| no_action \| cascade \| set_null` |  | Action applied to referencing rows when the parent row is deleted. Absent means restrict. |
...
| `column_replacement.source.insert_default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacement.source.insert_default.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacement.source.insert_default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacement.source.missing_value.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacement.source.missing_value.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacement.source.missing_value.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacement.source.type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of every stored cell. |
...
| `column_replacement.target.insert_default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacement.target.insert_default.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacement.target.insert_default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacement.target.missing_value.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacement.target.missing_value.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacement.target.missing_value.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacement.target.type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of every stored cell. |
...
| `column_replacement_request.default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacement_request.default.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacement_request.default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacement_request.type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of the replacement column. |
| `compacted_at` | `string` | Yes | RFC 3339 timestamp of terminal compaction. The zero timestamp means not compacted. |
...
| `column_replacements[].replacement.source.insert_default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacements[].replacement.source.insert_default.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacements[].replacement.source.insert_default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacements[].replacement.source.missing_value.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacements[].replacement.source.missing_value.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacements[].replacement.source.missing_value.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacements[].replacement.source.type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of every stored cell. |
...
| `column_replacements[].replacement.target.insert_default.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacements[].replacement.target.insert_default.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacements[].replacement.target.insert_default.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacements[].replacement.target.missing_value.bytes` | `array of integer` |  | Literal bytes as unsigned octets. |
| `column_replacements[].replacement.target.missing_value.float64` | `number` |  | Literal used when the column type is float64. |
| `column_replacements[].replacement.target.missing_value.func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacements[].replacement.target.type` | `text \| int64 \| float64 \| bool \| bytes` | Yes | Scalar type of every stored cell. |
...
## `statistics/frequency.v1`

A bounded query-tree-family workload score at one durable decay epoch.

| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `count` | `integer` | Yes | Saturating recent appearance score. |
| `epoch` | `integer` | Yes | Durable decay epoch for this score. |
