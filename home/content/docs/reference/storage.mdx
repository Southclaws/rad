...
| `schema.tables[].columns[].default.func` | `uuid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `columns[].insert_default.func` | `uuid \| now_ms \| increment` |  | Generator function. Present when the default is generated per row instead of a literal. |
...
| `columns[].missing_value.func` | `uuid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present in the shape because the default-value form is shared. |
...
| `column_replacement.source.insert_default.func` | `uuid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacement.source.missing_value.func` | `uuid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacement.target.insert_default.func` | `uuid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacement.target.missing_value.func` | `uuid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacement_request.default.func` | `uuid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacements[].replacement.source.insert_default.func` | `uuid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacements[].replacement.source.missing_value.func` | `uuid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
...
| `column_replacements[].replacement.target.insert_default.func` | `uuid \| now_ms \| increment` |  | Generator function for per-row defaults. |
...
| `column_replacements[].replacement.target.missing_value.func` | `uuid \| now_ms \| increment` |  | Generator function. Never valid for missing values; present because the default-value form is shared. |
