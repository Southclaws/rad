...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `foreign_key` | `ForeignKeyDefinition` | Yes |  |
| `kind` | `create_foreign_key` | Yes |  |
| `name` | `StatementName` | Yes |  |
| `table_id` | `SchemaID` | Yes |  |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `foreign_key` | `CatalogName` | Yes |  |
| `kind` | `delete_foreign_key` | Yes |  |
| `name` | `StatementName` | Yes |  |
| `table_id` | `SchemaID` | Yes |  |
...
| `name` | `CatalogName` | Yes |  |
| `on_delete` | `restrict \| no_action \| cascade \| set_null` |  |  |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `func` | `uuid_v4 \| uuid_v7 \| ulid \| xid \| now_ms \| increment` | Yes | A builtin generator. `uuid_v4`, `uuid_v7`, `ulid`, and `xid` require a bytes column with the matching identifier format; `now_ms` and `increment` require int64. |
| `kind` | `generator` | Yes |  |
