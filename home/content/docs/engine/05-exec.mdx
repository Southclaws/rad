...
relation-binding design's identical-plan discharge (a nondeterministic
binding may be re-executed per reference precisely because replaying the
identical sub-plan provably re-yields the committed bag —
tasks/1-todo/relation-bindings.md).
