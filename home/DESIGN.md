...
Aesthetic lane: vibey matrixy green terminal kinda vibes but not cringe yknow?
follow the figma designs i provide fairly closely.

Mood, in one phrase: _a phosphor-green terminal glowing, clean, precise, quietly
hacker-romantic._ The surface IS part of the brand, so the near-black carries a
whisper of green rather than being pure neutral. keep it subtle tho.
...
page yet, it's a bit annoying to design both so i'll do that another day...

Color strategy: one saturated green spread across the surface
